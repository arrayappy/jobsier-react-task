...
export const Blog = () => {
  ...
  axios(
      {
        method: "post",
        url: `https://crudcrud.com/api/95c09bac19d94dbbbb1bca3bdf16639c/blogs`,
        data:{
          "title": "test1",
    ...
    axios.get('https://crudcrud.com/api/95c09bac19d94dbbbb1bca3bdf16639c/blogs')
      .then(res => {
  ...
  const deleteBlog = (blogId) => {
    axios.delete(`https://crudcrud.com/api/95c09bac19d94dbbbb1bca3bdf16639c/blogs/${blogId}`)
  ...
  const editBlog = () => {
    ...
    dispatch(setBlogs(ctx.blogs.map(blog => blog._id === editId ? editData : blog)));
  }
  ...
  const addBlog = () => {
    ...
    axios(
      ...
      dispatch(setBlogs([...ctx.blogs, {title: title.current.value, content: content.current.value, date: date.current.value, image: image.current.value}]));
    console.log(title.current.value, content.current.value, date.current.value, image.current.value);
  }
  ...
  return (
    <Layout>
          <Flex
                ...
                <Button size={'sm'} mb='8px' onClick={onOpen1}>Add Blog</Button>
                ...
                <Modal isOpen={isOpen2} onClose={onClose2}>
                  ...
                  <ModalContent>
                    ...
                    <MenuList
                      ...
                      minWidth="148px"
                    >
                      <MenuItem onClick={() => editBlogButton(blog._id)}> Edit </MenuItem>
                      <MenuItem onClick={() => deleteBlog(blog._id)}> Delete </MenuItem>
                    </MenuList>
                  </Menu>
											<Flex>
												<Flex>
